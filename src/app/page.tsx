            ...
            <div className="flex flex-col lg:flex-row items-center gap-12">
              ...
              <div className="flex-1 text-center lg:text-left">
                <div className="inline-flex items-center gap-2 bg-yellow-400/10 border border-yellow-400/30 rounded-full px-4 py-2 mb-6">
                  ...
                  <span className="text-yellow-400 text-sm font-medium">रेफरल कमीशन · पासिव इनकम</span>
                </div>
                ...
                <p className="text-lg sm:text-xl text-gray-300 mb-8 max-w-xl">
                  भुगतान टास्क से पैसे कमाएं, दोस्तों को आमंत्रित करके अतिरिक्त कमीशन पाएं!
                </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-black text-white mb-4">
                <span className="text-yellow-400">कमीशन</span> प्रणाली
              </h2>
              <p className="text-gray-400 max-w-2xl mx-auto">
                दोस्तों को आमंत्रित करें और कमीशन कमाएं। जितने अधिक दोस्त, उतनी अधिक कमाई!
              </p>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-r from-yellow-400/20 via-yellow-500/10 to-yellow-400/20 rounded-3xl p-8 sm:p-12 border border-yellow-400/30 text-center">
              ...
              <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
                आज ही 9INR डाउनलोड करें और रेफरल कमीशन से पासिव इनकम कमाना शुरू करें!
              </p>
              <button 
                onClick={handleDownload}
